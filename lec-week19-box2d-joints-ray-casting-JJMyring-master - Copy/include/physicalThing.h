...
protected:
	...
	float mk_fDensity = 0.3f; //!< Density of the material - used to give mass
	float mk_fFriction = 1.1f; //!< Friction - I guess this is only friction from movement, not when static
